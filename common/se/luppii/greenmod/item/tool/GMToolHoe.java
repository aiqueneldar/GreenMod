...
import se.luppii.greenmod.item.GMItem;

public class GMToolHoe extends GMTool {

	public static final Block[] blocksEffectiveAgainst = new Block [] { Block.tilledField };
	
	public GMToolHoe(int par1, EnumToolMaterial par2EnumToolMaterial) {
