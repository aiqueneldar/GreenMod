...
public class GMBlockOreGem extends GMMultiBlock {
	
	private static String[] names = new String[] { "ruby", "sapphire" };
	
	public GMBlockOreGem(int par1) {
		super(par1, Material.iron, names);
		this.setHardness(2.0F);
		this.setResistance(10.0F);
		this.setStepSound(soundStoneFootstep);
		this.setUnlocalizedName("greenmod.block.ore.gem");
		MinecraftForge.setBlockHarvestLevel(this, "pickaxe", 2);
	}
	
	@Override
	public int idDropped(int par1, Random par2Random, int par3) {
		return GreenMod.multiGem.itemID;
	}
